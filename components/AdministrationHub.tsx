...
const AdministrationHub: React.FC = () => {
  ...
  return <>
    ...
    {open && <div className="fixed inset-0 z-[565] bg-black/70 backdrop-blur-sm" onClick={() => setOpen(false)}>
      <aside className="flex min-h-full w-full max-w-[470px] flex-col border-r border-white/10 bg-[#121117] text-white shadow-2xl" onClick={event => event.stopPropagation()}>
