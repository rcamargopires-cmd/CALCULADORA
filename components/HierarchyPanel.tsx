...
const roleLabel = (role: UserRole) => role === 'admin' ? 'Administrador' : role === 'manager' ? 'Gestor' : role === 'evaluator' ? 'Avaliador MarketIQ' : 'Vendedor';
