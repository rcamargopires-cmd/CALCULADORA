...
const friendlyError = (code?: string) => {
  switch (code) {
    ...
    case 'auth/unauthorized-domain':
      return 'Este endereço ainda não está autorizado no Firebase. Fale com o administrador.';
      ...
      <div className="w-full max-w-md overflow-hidden rounded-[32px] border border-white/10 bg-zinc-900 shadow-2xl">
        <div className="p-7 md:p-8">
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-zinc-300">MOTYQ</p>
            <p className="mt-1 text-[10px] font-medium uppercase tracking-[0.16em] text-zinc-600">Automotive Intelligence Platform</p>
