    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-xl shadow-2xl w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-1">DealMaster</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-white hover:bg-gray-100 text-black font-bold py-3 rounded transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
          >
        ...
        <div className="mt-6 text-center text-xs text-zinc-600">
          <p>O acesso é restrito apenas a usuários cadastrados pelo administrador.</p>
        </div>
      </div>
    </div>
  );
